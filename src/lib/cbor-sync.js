    ...
    var CBOR = (function () {
      ...
      var api = {
        ...
        encode: function (data, format) {
          console.log('============encode', data, format);
        ...
        encodeDataItem: function (data, format) {
          console.log('============encodeDataItem:data', data)
          console.log('============encodeDataItem:format', format)
          for (var i = 0; i < writerFunctions.length; i++) {
            var func = writerFunctions[i];
            var writer = func(format);
            console.log('============encodeDataItem:writer', writer)
            if (writer) {
          ...
          console.log('============encodeDataItem:error', format)
          throw new Error('Unsupported output format: ' + format);
        },
